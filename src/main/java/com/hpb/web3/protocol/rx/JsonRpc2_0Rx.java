...
import com.hpb.web3.protocol.core.filters.BlockFilter;
import com.hpb.web3.protocol.core.filters.LogFilter;
import com.hpb.web3.protocol.core.filters.PendingTransactionFilter;
...
public class JsonRpc2_0Rx {
    ...
    public Observable<Log> hpbLogObservable(
            com.hpb.web3.protocol.core.methods.request.HpbFilter hpbFilter, long pollingInterval) {
    ...
    private <T> void run(
            com.hpb.web3.protocol.core.filters.Filter<T> filter, Subscriber<? super T> subscriber,
