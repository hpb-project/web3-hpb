package io.hpb.web3.ens.contracts.generated;
...
public class PublicResolver extends Contract {
    ...
    ;
    @Deprecated
    protected PublicResolver(String contractAddress, Web3 web3, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3, credentials, gasPrice, gasLimit);
    }
    protected PublicResolver(String contractAddress, Web3 web3, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3, credentials, contractGasProvider);
    }
    @Deprecated
    protected PublicResolver(String contractAddress, Web3 web3, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3, transactionManager, gasPrice, gasLimit);
    }
    protected PublicResolver(String contractAddress, Web3 web3, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public RemoteCall<TransactionReceipt> setText(byte[] node, String key, String value) {
        final Function function = new Function(
                FUNC_SETTEXT, 
                Arrays.<Type>asList(new io.hpb.web3.abi.datatypes.generated.Bytes32(node), 
                new io.hpb.web3.abi.datatypes.Utf8String(key), 
                new io.hpb.web3.abi.datatypes.Utf8String(value)), 
    ...
    public RemoteCall<Tuple2<BigInteger, byte[]>> ABI(byte[] node, BigInteger contentTypes) {
        final Function function = new Function(FUNC_ABI, 
                Arrays.<Type>asList(new io.hpb.web3.abi.datatypes.generated.Bytes32(node), 
                new io.hpb.web3.abi.datatypes.generated.Uint256(contentTypes)), 
    ...
    public RemoteCall<TransactionReceipt> setPubkey(byte[] node, byte[] x, byte[] y) {
        final Function function = new Function(
                FUNC_SETPUBKEY, 
                Arrays.<Type>asList(new io.hpb.web3.abi.datatypes.generated.Bytes32(node), 
                new io.hpb.web3.abi.datatypes.generated.Bytes32(x), 
                new io.hpb.web3.abi.datatypes.generated.Bytes32(y)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> setABI(byte[] node, BigInteger contentType, byte[] data) {
        final Function function = new Function(
                FUNC_SETABI, 
                Arrays.<Type>asList(new io.hpb.web3.abi.datatypes.generated.Bytes32(node), 
                new io.hpb.web3.abi.datatypes.generated.Uint256(contentType), 
    ...
    public RemoteCall<TransactionReceipt> setName(byte[] node, String name) {
        final Function function = new Function(
                FUNC_SETNAME, 
                Arrays.<Type>asList(new io.hpb.web3.abi.datatypes.generated.Bytes32(node), 
                new io.hpb.web3.abi.datatypes.Utf8String(name)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    public RemoteCall<TransactionReceipt> setContent(byte[] node, byte[] hash) {
        final Function function = new Function(
                FUNC_SETCONTENT, 
                Arrays.<Type>asList(new io.hpb.web3.abi.datatypes.generated.Bytes32(node), 
                new io.hpb.web3.abi.datatypes.generated.Bytes32(hash)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> setAddr(byte[] node, String addr) {
        final Function function = new Function(
                FUNC_SETADDR, 
                Arrays.<Type>asList(new io.hpb.web3.abi.datatypes.generated.Bytes32(node), 
                new io.hpb.web3.abi.datatypes.Address(addr)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    public static RemoteCall<PublicResolver> deploy(Web3 web3, Credentials credentials, ContractGasProvider contractGasProvider, String ensAddr) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new io.hpb.web3.abi.datatypes.Address(ensAddr)));
        return deployRemoteCall(PublicResolver.class, web3, credentials, contractGasProvider, BINARY, encodedConstructor);
    }
    public static RemoteCall<PublicResolver> deploy(Web3 web3, TransactionManager transactionManager, ContractGasProvider contractGasProvider, String ensAddr) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new io.hpb.web3.abi.datatypes.Address(ensAddr)));
        return deployRemoteCall(PublicResolver.class, web3, transactionManager, contractGasProvider, BINARY, encodedConstructor);
    }
    @Deprecated
    public static RemoteCall<PublicResolver> deploy(Web3 web3, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, String ensAddr) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new io.hpb.web3.abi.datatypes.Address(ensAddr)));
        return deployRemoteCall(PublicResolver.class, web3, credentials, gasPrice, gasLimit, BINARY, encodedConstructor);
    }
    @Deprecated
    public static RemoteCall<PublicResolver> deploy(Web3 web3, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit, String ensAddr) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new io.hpb.web3.abi.datatypes.Address(ensAddr)));
        return deployRemoteCall(PublicResolver.class, web3, transactionManager, gasPrice, gasLimit, BINARY, encodedConstructor);
    }
    ...
    public Flowable<AddrChangedEventResponse> addrChangedEventFlowable(HpbFilter filter) {
        return web3.hpbLogFlowable(filter).map(new io.reactivex.functions.Function<Log, AddrChangedEventResponse>() {
            @Override
    ...
    public Flowable<ContentChangedEventResponse> contentChangedEventFlowable(HpbFilter filter) {
        return web3.hpbLogFlowable(filter).map(new io.reactivex.functions.Function<Log, ContentChangedEventResponse>() {
            @Override
    ...
    public Flowable<NameChangedEventResponse> nameChangedEventFlowable(HpbFilter filter) {
        return web3.hpbLogFlowable(filter).map(new io.reactivex.functions.Function<Log, NameChangedEventResponse>() {
            @Override
    ...
    public Flowable<ABIChangedEventResponse> aBIChangedEventFlowable(HpbFilter filter) {
        return web3.hpbLogFlowable(filter).map(new io.reactivex.functions.Function<Log, ABIChangedEventResponse>() {
            @Override
    ...
    public Flowable<PubkeyChangedEventResponse> pubkeyChangedEventFlowable(HpbFilter filter) {
        return web3.hpbLogFlowable(filter).map(new io.reactivex.functions.Function<Log, PubkeyChangedEventResponse>() {
            @Override
    ...
    public Flowable<TextChangedEventResponse> textChangedEventFlowable(HpbFilter filter) {
        return web3.hpbLogFlowable(filter).map(new io.reactivex.functions.Function<Log, TextChangedEventResponse>() {
            @Override
    ...
    @Deprecated
    public static PublicResolver load(String contractAddress, Web3 web3, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new PublicResolver(contractAddress, web3, credentials, gasPrice, gasLimit);
    }
    @Deprecated
    public static PublicResolver load(String contractAddress, Web3 web3, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new PublicResolver(contractAddress, web3, transactionManager, gasPrice, gasLimit);
    }
    public static PublicResolver load(String contractAddress, Web3 web3, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new PublicResolver(contractAddress, web3, credentials, contractGasProvider);
    }
    public static PublicResolver load(String contractAddress, Web3 web3, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new PublicResolver(contractAddress, web3, transactionManager, contractGasProvider);
    }
