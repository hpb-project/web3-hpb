...
public class ENS extends Contract {
    ...
    ;
    @Deprecated
    protected ENS(String contractAddress, Web3 web3, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3, credentials, gasPrice, gasLimit);
    }
    protected ENS(String contractAddress, Web3 web3, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3, credentials, contractGasProvider);
    }
    @Deprecated
    protected ENS(String contractAddress, Web3 web3, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3, transactionManager, gasPrice, gasLimit);
    }
    protected ENS(String contractAddress, Web3 web3, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public RemoteCall<TransactionReceipt> setSubnodeOwner(byte[] node, byte[] label, String owner) {
        final Function function = new Function(
                ...
                Arrays.<Type>asList(new io.hpb.web3.abi.datatypes.generated.Bytes32(node), 
                new io.hpb.web3.abi.datatypes.generated.Bytes32(label), 
                new io.hpb.web3.abi.datatypes.Address(owner)), 
    ...
    public RemoteCall<TransactionReceipt> setTTL(byte[] node, BigInteger ttl) {
        final Function function = new Function(
                FUNC_SETTTL, 
                Arrays.<Type>asList(new io.hpb.web3.abi.datatypes.generated.Bytes32(node), 
                new io.hpb.web3.abi.datatypes.generated.Uint64(ttl)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> setResolver(byte[] node, String resolver) {
        final Function function = new Function(
                FUNC_SETRESOLVER, 
                Arrays.<Type>asList(new io.hpb.web3.abi.datatypes.generated.Bytes32(node), 
                new io.hpb.web3.abi.datatypes.Address(resolver)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public static RemoteCall<ENS> deploy(Web3 web3, Credentials credentials, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(ENS.class, web3, credentials, contractGasProvider, BINARY, "");
    }
    public static RemoteCall<ENS> deploy(Web3 web3, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(ENS.class, web3, transactionManager, contractGasProvider, BINARY, "");
    }
    @Deprecated
    public static RemoteCall<ENS> deploy(Web3 web3, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(ENS.class, web3, credentials, gasPrice, gasLimit, BINARY, "");
    }
    @Deprecated
    public static RemoteCall<ENS> deploy(Web3 web3, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(ENS.class, web3, transactionManager, gasPrice, gasLimit, BINARY, "");
    }
    ...
    public Flowable<NewOwnerEventResponse> newOwnerEventFlowable(HpbFilter filter) {
        return web3.hpbLogFlowable(filter).map(new io.reactivex.functions.Function<Log, NewOwnerEventResponse>() {
            @Override
    ...
    public Flowable<NewResolverEventResponse> newResolverEventFlowable(HpbFilter filter) {
        return web3.hpbLogFlowable(filter).map(new io.reactivex.functions.Function<Log, NewResolverEventResponse>() {
            @Override
    ...
    public Flowable<NewTTLEventResponse> newTTLEventFlowable(HpbFilter filter) {
        return web3.hpbLogFlowable(filter).map(new io.reactivex.functions.Function<Log, NewTTLEventResponse>() {
            @Override
    ...
    @Deprecated
    public static ENS load(String contractAddress, Web3 web3, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new ENS(contractAddress, web3, credentials, gasPrice, gasLimit);
    }
    @Deprecated
    public static ENS load(String contractAddress, Web3 web3, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new ENS(contractAddress, web3, transactionManager, gasPrice, gasLimit);
    }
    public static ENS load(String contractAddress, Web3 web3, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new ENS(contractAddress, web3, credentials, contractGasProvider);
    }
    public static ENS load(String contractAddress, Web3 web3, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new ENS(contractAddress, web3, transactionManager, contractGasProvider);
    }
