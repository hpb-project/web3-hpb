...
import io.hpb.web3.abi.datatypes.FixedPointType;
import io.hpb.web3.abi.datatypes.Int;
import io.hpb.web3.abi.datatypes.IntType;
    ...
    static Type instantiateArrayType(TypeReference ref, Object value)
        ...
        if (value instanceof List) {
            ...
            throw new ClassCastException(
                    "Arg of type "
                            + value.getClass()
                            + " should be a list to instantiate web3 Array");
        }
        ...
        if (arraySize <= 0) {
            ...
            Class<?> arrayClass =
                    Class.forName("io.hpb.web3.abi.datatypes.generated.StaticArray" + arraySize);
        ...
        try {
            Class<? extends StaticArray> arrayClass =
                    (Class<? extends StaticArray>)
                            Class.forName("io.hpb.web3.abi.datatypes.generated.StaticArray" + length);
