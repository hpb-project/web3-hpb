...
import io.hpb.web3.abi.datatypes.primitive.Byte;
import io.hpb.web3.abi.datatypes.primitive.Char;
import io.hpb.web3.abi.datatypes.primitive.Double;
import io.hpb.web3.abi.datatypes.primitive.Float;
import io.hpb.web3.abi.datatypes.primitive.Int;
import io.hpb.web3.abi.datatypes.primitive.Long;
import io.hpb.web3.abi.datatypes.primitive.Short;
...
public class SolidityFunctionWrapper extends Generator {
    ...
    private void buildConstantFunction(
        ...
        if (outputParameterTypes.isEmpty()) {
            ...
            ParameterizedTypeName parameterizedTupleType =
                    ParameterizedTypeName.get(
                            ClassName.get(
                                    "io.hpb.web3.tuples.generated", "Tuple" + returnTypes.size()),
    ...
    TypeSpec buildEventResponseObject(
        ...
        for (io.hpb.web3.codegen.SolidityFunctionWrapper.NamedTypeName namedType :
                indexedParameters) {
    ...
    MethodSpec buildEventFlowableFunction(
        ...
        flowableMethodBuilder.addStatement(
                "return web3.hpbLogFlowable(filter).map($L)", converter);
